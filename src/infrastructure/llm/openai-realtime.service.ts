...
- Ne dis jamais que tu as appelé une API; contente-toi de l'action (transfert/message).`;
    ...
    this.send({
      ...
      session: {
        ...
        // Formats audio : par défaut PCM16.
        // Certains canaux téléphonie (ex: Twilio Media Streams) peuvent utiliser g711_ulaw.
        input_audio_format: this.audioOptions?.inputAudioFormat || 'pcm16',
        output_audio_format: this.audioOptions?.outputAudioFormat || 'pcm16',
